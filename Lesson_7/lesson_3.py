...
class Cell:
    ...
    def __str__(self):
        return f"Клетка состоит из {self.number_cells} ячеек"
    ...
    def __sub__(self, other):
        if self.number_cells > other.number_cells:
            ...
            return f"Вычетание не может быть произведено!"
    ...
    def make_order(self, cell_row):
        rows, tail = self.number_cells // cell_row, self.number_cells % cell_row
        return f"{'*' * cell_row}\\n" * rows + f"{('*' * tail)}"
